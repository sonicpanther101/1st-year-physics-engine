...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("src/shaders/colours vert.glsl", "src/shaders/colours frag.glsl");
    Shader lightCubeShader("src/shaders/light vert.glsl", "src/shaders/light frag.glsl");
